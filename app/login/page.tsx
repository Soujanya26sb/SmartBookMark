...
export default function Login() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 relative overflow-hidden">
      ...
      <div className="relative text-center">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-12 max-w-md">
          <div className="mb-8">
          ...
          <button
            onClick={login}
            className="w-full bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 px-6 py-3 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-3"
          >
